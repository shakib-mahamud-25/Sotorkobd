      ...
      <div className="mx-auto max-w-6xl px-5 py-14">
        <div className="flex flex-col gap-8 sm:flex-row sm:items-start sm:justify-between">
          ...
          <div className="flex gap-10 text-sm">
            {/* V2: added resources link — the crisis/safety resources page.
                Placed here (calm, permanent, footer-level) rather than as
                a prominent nav item, per spec: contextual, not an
                emergency banner. */}
            <Link
              href="/resources"
